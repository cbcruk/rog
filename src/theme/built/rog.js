...
/**
 * rog theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { rogTheme } from './rog';
 *   import './rog.css';
 */
export const rogTheme = {
  name: 'rog',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "var(--font-noto-sans-kr), system-ui, -apple-system, \"Apple SD Gothic Neo\", \"Malgun Gothic\", sans-serif",
    "--font-family-heading": "var(--font-noto-sans-kr), system-ui, -apple-system, \"Apple SD Gothic Neo\", \"Malgun Gothic\", sans-serif",
