...
import { initDb, upsertSession } from './db.mjs'
...
function generateMarkdown(analysis) {
  const { summary, splits, segments, laps, consistency, highlights, heartRate, fatigue, elevation, intervals, metadata } = analysis
...
function printSummary(analysis) {
  const { summary, splits, consistency, metadata, intervals } = analysis
